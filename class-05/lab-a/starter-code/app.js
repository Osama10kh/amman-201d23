...
function multiplyArray(multArr) { //eslint-disable-line
  let multAr = [2, 3, 4];
  let multiple = multAr[0]*multAr[1]*multAr[2];
  let msg = 'The numbers '+multAr[0]+','+multAr[1]+','+multAr[2]+' have a product of '+multiple+'.';
  return[multiple, msg]
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  let msg = 'The numbers '+testDynamicArray[0]+','+testDynamicArray[1]+','+testDynamicArray[2]+','+testDynamicArray[3]+','+testDynamicArray[4]+' have a product of '+multiply+'.';
  return [multiply, msg]
}
